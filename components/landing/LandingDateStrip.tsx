...
export function LandingDateStrip({ label, hint, items }: LandingDateStripProps) {
  return (
    <section className="w-full rounded-[1.75rem] border border-neutral-200/70 bg-white/85 p-4 shadow-[0_14px_36px_rgba(15,23,42,0.05)] backdrop-blur dark:border-white/10 dark:bg-neutral-950/70">
