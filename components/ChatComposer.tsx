...
export const ChatComposer = memo(function ChatComposer({
  ...
  return (
    <div
      className="group/typing-glow relative flex min-h-[52px] w-full min-w-0 max-w-2xl items-stretch overflow-visible rounded-2xl border-[1px] border-transparent bg-white shadow-sm dark:bg-neutral-900 sm:min-h-[60px] lg:max-w-4xl py-1.5 sm:py-2 pr-1 sm:pr-1.5"
