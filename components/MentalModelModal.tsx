...
export function MentalModelModal({
  ...
  const modalContent = (
    ...
    >
      <div
        className="relative rounded-3xl shadow-xl max-w-lg w-full max-h-[85vh] overflow-hidden flex flex-col bg-background border border-neutral-200 dark:border-neutral-700"
